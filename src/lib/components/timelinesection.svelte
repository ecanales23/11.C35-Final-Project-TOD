    ...
    <details class="limitations-accordion">
      <summary class="limitations-summary">
        <div class="summary-content">
          ...
          <h2 class="limitations-title-small">Project Limitations</h2>
        </div>
      ...
      <div class="limitations-grid">
        ...
        <div class="limitation-item">
          ...
          <p>Our visualization highlights relative patterns and possible mismatches instead of definitively proving whether a project meets a specific demand.</p>
        </div>
      </div>
    </details>
  </section>
